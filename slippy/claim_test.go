...
// held; a run with a step or component IN FLIGHT is refused unless the caller named the
// status it is running under; and only then does a held claim take the idempotent no-op arm,
// returning the RECORDED prior with nothing written.
//
...
// reachable for an empty if_status, since a non-empty one that does not contain the status
// already returned at the compare-and-set and one that does contain it makes the arm's own
// `!slices.Contains` clause false. That is the property the doubling buys — drop the clause
...
func TestDecideClaim_Table(t *testing.T) {
	...
	tests := []struct {
		...
		{"claim held out of failed, a step running / if_status=anyStatus: pending while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusPending, SlipStatusFailed, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of promoted, a step running / if_status=anyStatus: pending while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusPending, SlipStatusPromoted, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of failed, a step running / if_status=anyStatus: in_progress while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusInProgress, SlipStatusFailed, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of promoted, a step running / if_status=anyStatus: in_progress while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusInProgress, SlipStatusPromoted, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of failed, a step running / if_status=anyStatus: compensating while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusCompensating, SlipStatusFailed, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of promoted, a step running / if_status=anyStatus: compensating while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusCompensating, SlipStatusPromoted, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of failed, a step running / if_status=anyStatus: failed while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusFailed, SlipStatusFailed, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of promoted, a step running / if_status=anyStatus: failed while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusFailed, SlipStatusPromoted, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of failed, a step running / if_status=anyStatus: completed while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusCompleted, SlipStatusFailed, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of promoted, a step running / if_status=anyStatus: completed while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusCompleted, SlipStatusPromoted, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of failed, a step running / if_status=anyStatus: compensated while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusCompensated, SlipStatusFailed, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of promoted, a step running / if_status=anyStatus: compensated while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusCompensated, SlipStatusPromoted, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of failed, a step running / if_status=anyStatus: abandoned while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusAbandoned, SlipStatusFailed, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of promoted, a step running / if_status=anyStatus: abandoned while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusAbandoned, SlipStatusPromoted, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of failed, a step running / if_status=anyStatus: promoted while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusPromoted, SlipStatusFailed, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of promoted, a step running / if_status=anyStatus: promoted while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusPromoted, SlipStatusPromoted, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of in_progress, a step running / if_status=anyStatus: in_progress while a step of the run is executing: refused — a recorded claim is no exemption, a nil if_status never adopts a run in flight", SlipStatusInProgress, SlipStatusInProgress, true, anyStatus, "", false, ErrClaimPreconditionFailed},
		...
		{"claim held out of pending, a step running / if_status=anyStatus: the same row, asked without an if_status: refused, because nothing named the status of a run in flight", SlipStatusPending, SlipStatusPending, true, anyStatus, "", false, ErrClaimPreconditionFailed},
